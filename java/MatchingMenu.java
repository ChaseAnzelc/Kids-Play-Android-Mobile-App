...
public class MatchingMenu extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.matching_game_menu, container, false);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_left:
                ...
                ft1.add(R.id.fragment_list, ticTacToeMenu);
                ft1.commit();
            ...
            case R.id.button_right:
                ...
                ft2.add(R.id.fragment_list, slidingMenu);
                ft2.commit();
            ...
            case R.id.start_game:
                ...
                ft3.replace(R.id.fragment_list, matchingGameFragment);
